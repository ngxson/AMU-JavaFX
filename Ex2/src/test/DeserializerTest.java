...
class DeserializerTest {
  ...
  public void testVelocity() throws IOException {
    ...
    assertEquals(14772.3907366372, velocity.getKilometersPerHour(), 1e-9);
    assertEquals(4.1034418713, velocity.getKilometersPerSecond(), 1e-9);
  }
  ...
  public void TestDoc() throws IOException {
    Document doc =
      mapper.readValue(fetchJson("resources/doc.json"), Document.class);
